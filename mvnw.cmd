...
@REM -----------------
@REM   JAVA_HOME - location of a JDK home dir, required when download maven
@REM              java based on the value of this env var
...
@REM check for pre script, once with hierarchical lookup, once with legacy check
...
IF NOT EXIST "%MAVEN_PROJECTBASEDIR%\.mvn\wrapper\maven-wrapper.jar" (
    echo Downloading Maven Wrapper 3.3.2 ...
    powershell -Command "&{"^
